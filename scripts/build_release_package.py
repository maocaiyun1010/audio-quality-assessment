...
# 外发 ZIP/文件夹名仅用 ASCII，避免部分 Windows/解压工具对中文路径兼容问题
PACKAGE_DIRNAME = "speaker_audio_eval_V1.3"
...
def main() -> int:
    ...
    print()
    print(
        f        "外发说明: 将 {zip_name if not args.no_zip else folder_name} 发给对方，"
        "解压后双击 InstallDeps.bat（或一键安装依赖.bat），再 StartWebUI.bat。"
    )
    return 0
